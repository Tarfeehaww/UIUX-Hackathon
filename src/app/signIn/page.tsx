...
<p className="mt-5 ml-16 text-sm text-zinc-300">Forgotted your password?</p>
</div>


<div className="flex justify-center mt-9 text-center text-zinc-500/70">
<p>
    By Login in, you agree to {'Nike\u0027s'} <span className="underline underline-offset-2">Privacy Policy</span> and <span className="underline underline-offset-2">Terms of Use</span>
</p>
</div>
